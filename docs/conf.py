...
module_dir = os.path.join(__location__, "../src/phopyqttimelineplotter")
try:
...
try:
    from phopyqttimelineplotter import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "PhoPyQtTimelinePlotter-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "PhoPyQtTimelinePlotter Documentation", "Pho Hale", "manual")
]
